...
<html>
  <head>
    ...
    <title>Venta de Lacteos La vaca Lola</title>
    ...
    <link rel="apple-touch-icon" href="../public/img/vaca.png">
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-mini"><b>La Vaca</b>Lola</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>La vaca Lola</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../files/usuarios/<?php echo $_SESSION['imagen']; ?>" class="user-image" alt="User Image"><!-- muestra la imagen que esta ligada al usuario -->
                  <span class="hidden-xs"><?php echo $_SESSION['nombre']; ?></span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="../files/usuarios/<?php echo $_SESSION['imagen']; ?>" class="img-circle" alt="User Image"><!-- muestra la imagen que esta ligada al usuario -->
                    <p>
                     <small>Venta de Lacteos</small>
                     La vaca Lola
                    </p>
                  </li>
