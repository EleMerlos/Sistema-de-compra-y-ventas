<?php
//require 'header.php';
ob_start();//Activacion del almacenamiento en el buffer
session_start();
...
<label>Serie:</label>
<input type="text" class="form-control" name="serie_comprobante" id="serie_comprobante" maxlength="7" placeholder="Numero">
</div>
<div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
<label>Numero(*):</label>
...
<div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
    <table id="detalles" class="table table-striped table-bordered table-condensed table-hover">
        <thead style="background-color: #ECDBBA">
            <th>opciones</th>
            <th>Articulos</th>
            <th>Cantidad</th>
            <th>Precio Compra</th>
...
<!---VENTANA MODAL--->
<div class="modal fadde" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btnbtn-default" data-dismiss="modal">Cerrar</button>
            </div>
        </div>
    </div>
</div>
